...
class Task {
    ...
    constructor(taskId: string, taskTitle: string, taskCompleted: boolean) {
        this.taskId = taskId;
...
class TaskManager {
    ...
    createTask(taskId: string, taskTitle: string, taskCompleted = false) {
    ...
    updateTask(taskId: string, taskTitle: string, taskCompleted?: boolean) {
